	...
	<div class="clearfixLeft" id="clearcontent">
		...
		<script type="text/javascript">
			...
			<div class="tb-booth tb-pic tb-s310">
				<a href="/uploads/{{$product['default_img']}}"><img src="/uploads/{{$product['default_img']}}" alt="细节展示放大镜特效" rel="/uploads/{{$product['default_img']}}" class="jqzoom" /></a>
			</div>
			<ul class="tb-thumb" id="thumblist">
			@foreach ($product_image as $pi)
				<li class="tb-selected">
					<div class="tb-pic tb-s40">
						<a href="#"><img src="/uploads/{{$pi['url']}}" mid="/uploads/{{$pi['url']}}" big="/uploads/{{$pi['url']}}"></a>
					</div>
				</li>
				@endforeach
		...
		<div class="tb-detail-list">
			...
			<div class="tb-detail-price">
				<li class="price iteminfo_price">
					<dt>促销价</dt>
					<dd><em>¥</em><b class="sys_item_price">{{$product['shop_price']}}</b>  </dd>                                 
				</li>
							...
							<form class="theme-signin" name="loginform" action="" method="post">
								...
								<div class="theme-signin-left">
									...
									<div class="theme-options">
										...
										<ul id="option{{$value['name']}}">
											@foreach($value->optionvalue as $k =>$va)
											<li class="sku-line myoption @if($k==0) selected @endif" value="{{$va['id']}}">{{$va['name']}}<i></i></li>
											@endforeach
				...
				<div class="am-tab-panel am-fade">
					...
					@foreach($comments as $value)
						<li class="am-comment">
							<!-- 评论容器 -->
							<a href="">
								<img class="am-comment-avatar" src="{{$value->userinfo['image']}}" />
								<!-- 评论者头像 -->
							</a>
							...
							<div class="am-comment-main">
								...
								<header class="am-comment-hd">
									...
									<div class="am-comment-meta">
										<!-- 评论元数据 -->
										<a href="#link-to-user" class="am-comment-author">{{$value->userinfo['name']}}(未匿名)</a>
										<!-- 评论者 -->
										评论于
										<time datetime="">{{$value['create_time']}}</time>
									</div>
								</header>
						...
						<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
							...
							<li>
								<div class="i-pic limit">
									<img src="/user/images/imgsearch1.jpg" />
...
<script>
		...
		var prid={{$product['id']}};
		var ops='';
		$("li.myoption.selected").each(function(){
		    ops+=$(this).val()+"_";
        })
