						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									<div class="m-baseinfo">
										<a href="information.html">
											<img src="/user/images/getAvatar.do.jpg">
										</a>
								...
								<div class="m-userproperty">
									...
									<p class="m-bonus">
										<a href="bonus.html">
											<i><img src="/user/images/bonus.png"/></i>
									...
									<p class="m-coupon">
										<a href="coupon.html">
											<i><img src="/user/images/coupon.png"/></i>
									...
									<p class="m-bill">
										<a href="/user/ewallet">
											<i><img src="/user/images/wallet.png"/></i>
									...
									<p class="m-big">
										<a href="#">
											<i><img src="/user/images/day-to.png"/></i>
											<span class="m-title">签到有礼</span>
										</a>
									</p>
									<p class="m-big">
										<a href="#">
											<i><img src="/user/images/72h.png"/></i>
							...
							<div class="m-order">
								...
								<ul>
									<li><a href="order.html"><i><img src="/user/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order.html"><i><img src="/user/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order.html"><i><img src="/user/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order.html"><i><img src="/user/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="change.html"><i><img src="/user/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
							</div>
							<!--九宫格-->
							<div class="user-patternIcon">
								...
								<ul>
									...
									<a href="../home/shopcart.html"><li class="am-u-sm-4"><i class="am-icon-shopping-basket am-icon-md"></i><img src="/user/images/iconbig.png"/><p>购物车</p></li></a>
									<a href="collection.html"><li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i><img src="/user/images/iconsmall1.png"/><p>我的收藏</p></li></a>
									<a href="../home/home.html"><li class="am-u-sm-4"><i class="am-icon-gift am-icon-md"></i><img src="/user/images/iconsmall0.png"/><p>为你推荐</p></li></a>
									<a href="comment.html"><li class="am-u-sm-4"><i class="am-icon-pencil am-icon-md"></i><img src="/user/images/iconsmall3.png"/><p>好评宝贝</p></li></a>
									<a href="foot.html"><li class="am-u-sm-4"><i class="am-icon-clock-o am-icon-md"></i><img src="/user/images/iconsmall2.png"/><p>我的足迹</p></li></a>                                                                        
								</ul>
							</div>
							<!--物流 -->
								...
								<div class="s-content">
									<ul class="lg-list">
										...
										<li class="lg-item">
											<div class="item-info">
												<a href="#">
													<img src="/user/images/65.jpg_120x120xz.jpg" alt="抗严寒冬天保暖隔凉羊毛毡底鞋垫超薄0.35厘米厚吸汗排湿气舒适">
												</a>
										...
										<li class="lg-item">
											<div class="item-info">
												<a href="#">
													<img src="/user/images/88.jpg_120x120xz.jpg" alt="礼盒袜子女秋冬 纯棉袜加厚 女式中筒袜子 韩国可爱 女袜 女棉袜">
												</a>
								...
								<div class="s-content">
										...
										<div class="s-item">
											...
											<div class="s-pic">
												<a href="#" class="s-pic-link">
													<img src="/user/images/0-item_pic.jpg_220x220.jpg" alt="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰" title="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰" class="s-pic-img s-guess-item-img">
												</a>
											</div>
									...
									<div class="s-item-wrap">
										<div class="s-item">
											...
											<div class="s-pic">
												<a href="#" class="s-pic-link">
													<img src="/user/images/1-item_pic.jpg_220x220.jpg" alt="s925纯银千纸鹤锁骨链短款简约时尚韩版素银项链小清新秋款女配饰" title="s925纯银千纸鹤锁骨链短款简约时尚韩版素银项链小清新秋款女配饰" class="s-pic-img s-guess-item-img">
												</a>
											</div>
											<div class="s-price-box">
									...
									<div class="s-item-wrap">
										<div class="s-item">
											...
											<div class="s-pic">
												<a href="#" class="s-pic-link">
													<img src="/user/images/-0-saturn_solar.jpg_220x220.jpg" alt="4折抢购!十二生肖925银女戒指,时尚开口女戒" title="4折抢购!十二生肖925银女戒指,时尚开口女戒" class="s-pic-img s-guess-item-img">
												</a>
											</div>
											<div class="s-price-box">
							...
							<div class="new-goods-info">
								<a class="shop-info" href="#" target="_blank">
									<div class="face-img-panel">
										<img src="/user/images/imgsearch1.jpg" alt="">
									</div>
